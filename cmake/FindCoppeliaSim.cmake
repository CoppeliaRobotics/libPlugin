...
function(COPPELIASIM_GENERATE_STUBS GENERATED_OUTPUT_DIR)
    ...
    if(NOT "${COPPELIASIM_GENERATE_STUBS_LUA_FILE}" STREQUAL "")
        ...
        if(PLUGIN_VERSION GREATER 1)
            set(LUA_FILE_NAME ${LUA_FILE_NAME_WLE}_${PLUGIN_VERSION}.lua)
        else()
    ...
    if(PLUGIN_SHORT_NAME)
        if(PLUGIN_VERSION GREATER 1)
            set(REFERENCE_FILE_NAME sim${PLUGIN_SHORT_NAME}_${PLUGIN_VERSION}.htm)
            set(INDEX_FILE_NAME sim${PLUGIN_SHORT_NAME}_${PLUGIN_VERSION}.json)
        else()
...
function(COPPELIASIM_ADD_PLUGIN PLUGIN_TARGET_NAME)
    ...
    if(PLUGIN_VERSION GREATER 1)
        set(PLUGIN_TARGET_NAME_V "${PLUGIN_TARGET_NAME}_${PLUGIN_VERSION}")
    else()
