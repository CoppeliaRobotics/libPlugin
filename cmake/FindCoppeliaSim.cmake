...
function(COPPELIASIM_ADD_PLUGIN PLUGIN_TARGET_NAME)
    cmake_parse_arguments(COPPELIASIM_ADD_PLUGIN "" "" "SOURCES" ${ARGN})
    add_library(${PLUGIN_TARGET_NAME} SHARED ${COPPELIASIM_EXPORTED_SOURCES} ${COPPELIASIM_ADD_PLUGIN_SOURCES})
    target_include_directories(${PLUGIN_TARGET_NAME} PRIVATE ${COPPELIASIM_INCLUDE_DIR})
    target_link_libraries(${PLUGIN_TARGET_NAME} ${COPPELIASIM_LIBRARIES})
    target_link_libraries(${PLUGIN_TARGET_NAME} Boost::boost Boost::regex)
    install(TARGETS ${PLUGIN_TARGET_NAME} DESTINATION ${COPPELIASIM_PLUGINS_DIR})
